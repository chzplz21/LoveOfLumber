...
class ntt_link_to_social_networks extends WP_Widget
{
	...
	function widget($args, $instance) {
		...
		$ntt_facebook_icon = plugins_url( 'Images/facebookNew.png', __FILE__);
		$ntt_twitter_icon = plugins_url( 'Images/twitterNew.png', __FILE__);
		...
		<div id = "IconsContainer">
			...
			<a href ="<?php //echo $twitter; ?>"  class = "Icon">
				<img src = "<? //php echo $ntt_twitter_icon; ?>" height = "40px" width = "40px"> 
			</a>
			-->
			<a href ="<?php echo $facebook; ?>"  class = "Icon">
				<img src = "<?php echo $ntt_facebook_icon; ?>" height = "40px" width = "40px">
			</a>
		</div>
